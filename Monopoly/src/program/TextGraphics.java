...
public class TextGraphics
{
	...
	public static void fillBoard()
	{
		Data.textBoard = new String[][] {
				{"+---+---+---+---+---+---+---+---+---+---+---+"},
				{"| " + Data.l[20] + " | " + Data.l[21] + " | " + Data.l[22] + " | " + Data.l[23] + " | " + Data.l[24] + " | " + Data.l[25] + " | " + Data.l[26] + " | " + Data.l[27] + " | " + Data.l[28] + " | " + Data.l[29] + " | " + Data.l[30] + " | "},
				{"+---+---+---+---+---+---+---+---+---+---+---+"},
				{"| " + Data.l[19] + " |                                   | " + Data.l[31] + " |"},
				{"+---+                                   +---+"},
				{"| " + Data.l[18] + " |                                   | " + Data.l[32] + " |"},
				...
				{"| " + Data.l[11] + " |                                   | " + Data.l[39] + " |"},
				{"+---+---+---+---+---+---+---+---+---+---+---+"},
				{"| " + Data.l[10] + " | " + Data.l[9] + " | " + Data.l[8] + " | " + Data.l[7] + " | " + Data.l[6] + " | " + Data.l[5] + " | " + Data.l[4] + " | " + Data.l[3] + " | " + Data.l[2] + " | " + Data.l[1] + " |G" + Data.l[0] + "O|"},
				{"+---+---+---+---+---+---+---+---+---+---+---+"}
				};
	}
