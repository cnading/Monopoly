...
public class TurnMenu
{
	...
	public static void turnMenu()
	{
		...
		// selectOption
		System.out.println();
		System.out.println(Data.players.get(Data.turn).getName() + "'s" + " (" + Data.players.get(Data.turn).getPiece()
				+ ") turn! Balance: $" + Data.players.get(Data.turn).getBalance());
	...
	public static void rollDice()
	{
		...
		} else if (Data.players.get(Data.turn).getGetOutOfJailFreeCards() > 0)
		{
			...
			Data.players.get(Data.turn).setOutOfJailCounter(0);
			Data.players.get(Data.turn).setJail(false);
			Data.players.get(Data.turn)
					.setGetOutOfJailFreeCards(Data.players.get(Data.turn).getGetOutOfJailFreeCards() - 1);
			if (Data.players.get(Data.turn).isGoingBackwards() == false)
			{
				Data.players.get(Data.turn).setPosition(Data.players.get(Data.turn).getPosition() + roll);
			} else
	...
	public static void buyHousesMenu()
	{
		...
		{
			System.out.println();
			int numHouses = ((Property) Data.players.get(Data.turn).getProperties()
					.get(Data.players.get(Data.turn).getProperties().indexOf(props.get(choice2 - 1)))).getHouses();
			...
			{
				((Property) Data.players.get(Data.turn).getProperties()
						.get(Data.players.get(Data.turn).getProperties().indexOf(props.get(choice2 - 1))))
								.addHouses(choice3);
				int index = ((Property) Data.players.get(Data.turn).getProperties()
						.get(Data.players.get(Data.turn).getProperties().indexOf(props.get(choice2 - 1))))
								.getPosition();
				Data.board[index] = ((Property) Data.players.get(Data.turn).getProperties()
						.get(Data.players.get(Data.turn).getProperties().indexOf(props.get(choice2 - 1))));
				System.out.println("" + choice3 + " houses were added to " + Data.players.get(Data.turn).getProperties()
						.get(Data.players.get(Data.turn).getProperties().indexOf(props.get(choice2 - 1))).getName()
						+ ".");
				Data.players.get(Data.turn).setBalance(Data.players.get(Data.turn).getBalance()
						- ((Property) Data.players.get(Data.turn).getProperties()
								.get(Data.players.get(Data.turn).getProperties().indexOf(props.get(choice2 - 1))))
										.getHousePrice()
								* choice3);
		...
		if (choice == 2)
		{
			...
			{
				((Property) Data.players.get(Data.turn).getProperties()
						.get(Data.players.get(Data.turn).getProperties().indexOf(props.get(choice2 - 1)))).addHouses(1);
				((Property) Data.players.get(Data.turn).getProperties()
						.get(Data.players.get(Data.turn).getProperties().indexOf(props.get(choice2 - 1)))).addHotels(1);
				int index = ((Property) Data.players.get(Data.turn).getProperties()
						.get(Data.players.get(Data.turn).getProperties().indexOf(props.get(choice2 - 1))))
								.getPosition();
				Data.board[index] = ((Property) Data.players.get(Data.turn).getProperties()
						.get(Data.players.get(Data.turn).getProperties().indexOf(props.get(choice2 - 1))));
				System.out.println("A hotel was added to " + Data.players.get(Data.turn).getProperties()
						.get(Data.players.get(Data.turn).getProperties().indexOf(props.get(choice2 - 1))).getName()
						+ ".");
				Data.players.get(Data.turn).setBalance(Data.players.get(Data.turn).getBalance()
						- ((Property) Data.players.get(Data.turn).getProperties()
